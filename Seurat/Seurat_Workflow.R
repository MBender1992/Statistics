...
counts <- readMM("Seurat/data/DS1/matrix.mtx.gz")
barcodes <- read.table("Seurat/data/DS1/barcodes.tsv.gz", stringsAsFactors=F)[,1]
features <- read.csv("Seurat/data/DS1/features.tsv.gz", stringsAsFactors=F, sep="\t",
                     header=F)
