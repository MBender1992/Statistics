...
doublets <- readRDS("Seurat/data/GSE171524_doublets.rds")
...
## define index of doublets
ind_dbl <- rownames(merged_seurat@meta.data) %in% doublets

## remove doublets
merged_seurat <- merged_seurat[,which(!ind_dbl)]
